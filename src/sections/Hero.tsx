...
const Hero: FC = () => {
  ...
  const portateWidth = useTransform(scrollYProgress,[0,1],['100%','240%'])
  useEffect(() => {
    ...
    <div className='grid md:grid-cols-12 md:h-screen items-stretch sticky top-0'>
      <div className='md:col-span-7 flex flex-col justify-center'>
        <div className='container !max-w-full'>
          <motion.h1
              ...
              initial={{opacity: 0}}
              animate={{opacity: 1}}
              className='text-5xl md:text-6xl mt-40 md:mt-0 lg:text-7xl'>Crafting digital
            experiences
            through code and
            creative design
          </motion.h1>
      ...
      <div className='md:col-span-5 relative'>
        <motion.div  className='mt-20 md:mt-0 md:size-full md:absolute md:right-0 max-md:w-full' style={{
          ...
          <Image src={heroImage} priority alt='hero image' className='size-full object-cover'/>
        </motion.div>
      </div>
    </div>
